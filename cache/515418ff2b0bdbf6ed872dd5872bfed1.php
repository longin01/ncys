...
<div class="content">
<div class="bread-crumb"><a href="<?php echo $this->value['ListUrl']; ?>" title="<?php  echo $this->value['PicTypeName']; ?>"><?php  echo $this->value['PicTypeName']; ?></a></div>
...
<li><a href="<?php 	echo  $Host1.'pic_detail'.$Host2.$s['a_id'].$Host3.$PicTypeId.$Host4; ?>" title="<?php 	echo  $s['a_name'] ?>"><img src="<?php 	echo  $s['a_remarks'] ?>" alt="<?php 	echo  $s['a_name'] ?>" class="responsive-image" style="height:200px;object-fit:cover;"></a></li>
<?php  } ?>
</ul>
