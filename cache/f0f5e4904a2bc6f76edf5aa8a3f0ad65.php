			...
			<?php $mubantou=$this->value['Header'];$this->show($mubantou); ?>
                ...
                <div class="list-videos uk-margin-top uk-margin-bottom">
					...
					<div class="video-content">
                        <div class="read">
                            <div class="read-img">
                                <img src='<?php echo $this->value['Pic']; ?>'>
                            </div>
                            <!-- 标题 -->
                            ...
                            <div class="read-text uk-margin-top-remove uk-clearfix">
                                ...
                                <div class="read-btn uk-margin-bottom uk-float-left">
                                    <a href="<?php echo $this->value['CUrl']; ?>" class="uk-float-left uk-margin-large-right uk-button h-line ">点击浏览</a>
                                    <a href="<?php echo $this->value['CUrl']; ?>" class="uk-float-left uk-margin-large-right uk-button h-line ">快速浏览</a>
                                </div>
                                <p class="uk-float-left uk-margin-large-right">套图分类:<span><?php echo $this->value['ListName']; ?></span></p>
                    ...
                    <div class="video-head uk-clearfix">
                        <h3 class="h3-color uk-float-left"><?php echo $this->value['ListName']; ?>推荐套图</h3>
                        <a href="<?php echo $this->value['ListUrl']; ?>" class="more"><?php echo $this->value['ListName']; ?>更多推荐套图</a>
                    </div>
                    <div class="video-content uk-grid uk-grid-small">
							<?php  $PicType=$this->value['PicType']; $MYSQLVOD=(array)$this->value['PicTypeNCSQL'];shuffle($MYSQLVOD);  $Count=9;for ($x=0; $x<=$Count-1; $x++) {  $MYSQLVODs=$MYSQLVOD[$x];  ?>
							<div class="uk-width-1-3 uk-margin-bottom">

								<a href="<?php 	echo  $Host1.'pic_detail'.$Host2.$MYSQLVODs['a_id'].$Host3.$PicType.$Host4; ?>" class="video-pic video-pic-h uk-display-block"><img src='<?php 	echo  $MYSQLVODs['a_remarks'] ?>'></a>
