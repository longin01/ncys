...
<p><button class="button" onClick="location.href='<?php echo $this->value['CUrl']; ?>';">在线浏览</button></p>
...
<div class="content"><a href="<?php 	echo  $Host1.'pic_detail'.$Host2.$MYSQLVODs['a_id'].$Host3.$PicType.$Host4; ?>" title="<?php 	echo  $MYSQLVODs['a_name'] ?>"><img src="<?php 	echo  $MYSQLVODs['a_remarks'] ?>" alt="<?php 	echo  $MYSQLVODs['a_name'] ?>" class="imgPlay" style="height:200px;object-fit:cover;"></a></div>
<?php  } ?>
</div>
