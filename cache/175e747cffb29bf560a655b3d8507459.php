...
<head>
<meta charset="UTF-8">
<title><?php echo $this->value['WebTitle']; ?>-<?php  echo $this->value['BtTypeName']; ?></title>
...
<div class="center site-title"><a href="<?php echo $this->value['WEBUrl']; ?>" class="external"><h1><?php  echo $this->value['BtTypeName']; ?></h1></a></div>
...
<?php } ?>
<?php  $MYSQLVODS=(array)$this->value['BtTypeNCSQL'];$BtTypeId=$this->value['BtTypeId'];$GetMb_page=$this->value['BtTypePage']; $Count=21;$MYSQLVODS=PAGE($MYSQLVODS,$GetMb_page,$Count);  foreach($MYSQLVODS['source'] as $s){  ?>
<div class="entry"><a href="<?php 	echo  $Host1.'bt_detail'.$Host2.$s['d_id'].$Host3.$BtTypeId.$Host4; ?>" title="<?php 	echo  $s['d_name'] ?>" class="external"><img src="<?php 	echo  $s['d_pic'] ?>" alt="<?php 	echo  $s['d_name'] ?>" class="imgPlay" style="height:200px;object-fit:cover;"></a><div class="content"><h5><a href="<?php 	echo  $Host1.'bt_detail'.$Host2.$s['d_id'].$Host3.$BtTypeId.$Host4; ?>" title="<?php 	echo  $s['d_name'] ?>" class="external"><?php 	echo  $s['d_name'] ?></a></h5></div></div>
<?php  } ?>
