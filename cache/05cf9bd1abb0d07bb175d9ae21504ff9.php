...
<div class="slider-no-controls" data-snap-ignore="true"><div><a href="<?php echo $this->value['CUrl']; ?>" title="<?php echo $this->value['Name']; ?>"><img src="<?php echo $this->value['Pic']; ?>" alt="<?php echo $this->value['Name']; ?>" class="responsive-image" style="height:240px;object-fit:cover;"></a><p class="blog-slider-caption"><strong><?php echo $this->value['Name']; ?></strong><em><?php echo $this->value['Time']; ?></em><button class="buttonWrap button button-green contactSubmitButton" onClick="location.href='<?php echo $this->value['CUrl']; ?>';">在线播放</button></p></div></div>
<div class="decoration"></div>
...
<div class="decoration"></div>
<div class="recent-post"><a href="<?php 	echo  $Host1.'video_detail'.$Host2.$MYSQLVODs['d_id'].$Host3.$VideoType.$Host4; ?>" title="<?php 	echo  $MYSQLVODs['d_name'] ?>"><img src="<?php 	echo  $MYSQLVODs['d_pic'] ?>" alt="<?php 	echo  $MYSQLVODs['d_name'] ?>" class="responsive-image" style="height:200px;object-fit:cover;"></a></div>
<?php  } ?>
</div>
<div class="decoration"></div>
<div class="one-half-responsive">
