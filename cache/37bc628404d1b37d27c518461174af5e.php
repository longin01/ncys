...
<div class="embed-responsive embed-responsive-4by3 player-box">
<?php echo $this->value['Play']; ?>
</div>
</div>
<div class="animated article fadeinup delay-1">
<div class="p-20">
<div id="playtip" style="display:none;">
<h2 style="color:red;">每日限量观看5个视频，您今日次数已用完，您可以选择赚取观影次数，或者等明天次数恢复了观看</h2>
...
<button class="waves-effect waves-light btn-large primary-color block animated bouncein delay-4" onClick="location.href='<?php echo $this->value['CUrl']; ?>';">在线播放</button>
...
<p style="margin:5px 0;"><a href="<?php echo $VideoWebUrl?>" target="_blank"><img style="width:<?php echo $VideoPicUrlWidth?>;height:<?php echo $VideoPicUrlHeight?>;margin-bottom:2px;" src="<?php echo $VideoPicUrl?>"></a></p>
<?php } ?>       
<div class="swiper-container swiper-slider m-b-20">
...
<div class="swiper-slide"><a href="<?php 	echo  $Host1.'video_detail'.$Host2.$MYSQLVODs['d_id'].$Host3.$VideoType.$Host4; ?>" title="<?php 	echo  $MYSQLVODs['d_name'] ?>"><img src="<?php 	echo  $MYSQLVODs['d_pic'] ?>" alt="<?php 	echo  $MYSQLVODs['d_name'] ?>"></a></div>
<?php  } ?>
</div>
...
<div class="card"><div class="header-hover"><div class="details"><span><?php 	echo  $MYSQLVODs['d_name'] ?></span><span class="small"><?php 	echo   rand(5, 10000); ?> 人观看</span></div></div>
<div class="image"><a href="<?php 	echo  $Host1.'video_detail'.$Host2.$MYSQLVODs['d_id'].$Host3.$VideoType.$Host4; ?>" title="<?php 	echo  $MYSQLVODs['d_name'] ?>"><img src="<?php 	echo  $MYSQLVODs['d_pic'] ?>" alt="<?php 	echo  $MYSQLVODs['d_name'] ?>"></a></div></div>
<?php  } ?>
</div>
</div>
<!-- 页尾 开始 -->
