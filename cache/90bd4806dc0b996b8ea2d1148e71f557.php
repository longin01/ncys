...
<h2 class="page-title"><?php  echo $this->value['VideoTypeName']; ?></h2>
...
<a href="<?php 	echo  $Host1.'video_detail'.$Host2.$s['d_id'].$Host3.$VideoTypeId.$Host4; ?>" title="<?php 	echo  $s['d_name'] ?>" class="small-listing-item"><div class="entry-thumb"><img src="<?php 	echo  $s['d_pic'] ?>" alt="<?php 	echo  $s['d_name'] ?>" class="imgPlay" style="height:200px;object-fit:cover;"></div></a>
<?php  } ?>
<div class="clear"></div>
</div>
