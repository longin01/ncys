...
<div class="slider-no-controls" data-snap-ignore="true"><div><a href="<?php echo $this->value['CUrl']; ?>" title="<?php echo $this->value['Name']; ?>"><img src="<?php echo $this->value['Pic']; ?>" alt="<?php echo $this->value['Name']; ?>" class="responsive-image" style="height:240px;object-fit:cover;"></a><p class="blog-slider-caption"><strong><?php echo $this->value['Name']; ?></strong><em><?php echo $this->value['Time']; ?></em><button class="buttonWrap button button-green contactSubmitButton" onClick="location.href='<?php echo $this->value['CUrl']; ?>';">在线浏览</button></p></div></div>
<div class="decoration"></div>
...
<div class="decoration"></div>
<div class="recent-post"><a href="<?php 	echo  $Host1.'pic_detail'.$Host2.$MYSQLVODs['a_id'].$Host3.$PicType.$Host4; ?>" title="<?php 	echo  $MYSQLVODs['a_name'] ?>"><img src="<?php 	echo  $MYSQLVODs['a_remarks'] ?>" alt="<?php 	echo  $MYSQLVODs['a_name'] ?>" class="responsive-image" style="height:200px;object-fit:cover;"></a></div>
<?php  } ?>
</div>
<div class="decoration"></div>
<div class="one-half-responsive">
