...
<div class="v-read">
	...
	<div class="read-info">
		...
		<div class="read-text uk-margin-top-remove uk-clearfix">
			<p class="uk-float-left">影片分类:<span><?php echo $this->value['ListName']; ?></span></p><p class="uk-float-left">更新时间:<span><?php echo $this->value['Time']; ?></span></p>
		</div>	
		<div class="read-btn uk-margin-top uk-margin-bottom uk-clearfix">
			<a href="<?php echo $this->value['CUrl']; ?>" class="uk-float-left">手机播放</a><a href="<?php echo $this->value['CUrl']; ?>" class="uk-float-right">电脑播放</a>
		</div>
	</div>
</div>
...
<div class="v-type-favorite uk-clearfix">
	...
	<ul class="recom recom-play">
		<?php  $VideoType=$this->value['VideoType']; $MYSQLVOD=(array)$this->value['VideoTypeTTSQL'];shuffle($MYSQLVOD);  $Count=4;for ($x=0; $x<=$Count-1; $x++) {  $MYSQLVODs=$MYSQLVOD[$x];  ?>
			<li>
