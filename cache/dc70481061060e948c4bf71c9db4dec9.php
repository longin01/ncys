...
<div class="site-brand"><a href="<?php echo $this->value['WEBUrl']; ?>"><h1><?php echo $this->value['WebTitle']; ?></h1></a></div>
<div class="side-nav-panel-right"><a href="<?php echo $this->value['UserUrl']; ?>" class="side-nav-right"><i class="fa fa-user"></i></a></div>
</div>
<div class="side-nav-panel-left">
<ul id="slide-out-left" class="side-nav side-nav-panel collapsible">
<li class="profil"><img src="<?php echo $this->value['WebLogo']; ?>" alt="<?php echo $this->value['WebTitle']; ?>"><h2><?php echo $this->value['WebTitle']; ?></h2></li>
<li><a href="<?php echo $this->value['WEBUrl']; ?>"><i class="fa fa-home"></i>首页</a></li>
<li class="li-top"><div class="collapsible-header"><i class="fa fa-language"></i>选择语言 <span><i class="fa fa-caret-down"></i></span></div>
...
<li class="li-top"><div class="collapsible-header"><i class="fa fa-play"></i>视频一区 <span><i class="fa fa-caret-down"></i></span></div>
<div class="collapsible-body">
<ul class="side-nav-panel">
...
<li class="li-top"><div class="collapsible-header"><i class="fa fa-play"></i>视频二区 <span><i class="fa fa-caret-down"></i></span></div>
<div class="collapsible-body">
<ul class="side-nav-panel">
...
<li class="li-top"><div class="collapsible-header"><i class="fa fa-play"></i>视频三区 <span><i class="fa fa-caret-down"></i></span></div>
<div class="collapsible-body">
<ul class="side-nav-panel">
...
<li class="li-top"><div class="collapsible-header"><i class="fa fa-headphones"></i>电台收听 <span><i class="fa fa-caret-down"></i></span></div>
<div class="collapsible-body">
<ul class="side-nav-panel">
...
<li class="li-top">
<div class="collapsible-header"><i class="fa fa-cloud-download"></i>种子下载 <span><i class="fa fa-caret-down"></i></span></div>
<div class="collapsible-body">
<ul class="side-nav-panel">
...
<li class="li-top"><div class="collapsible-header"><i class="fa fa-image"></i>美图专区 <span><i class="fa fa-caret-down"></i></span></div>
<div class="collapsible-body">
<ul class="side-nav-panel">
...
<li class="li-top"><div class="collapsible-header"><i class="fa fa-book"></i>小说资源 <span><i class="fa fa-caret-down"></i></span></div>
<div class="collapsible-body">
<ul class="side-nav-panel">
...
<li class="li-top"><div class="collapsible-header"><i class="fa fa-link"></i>合作伙伴 <span><i class="fa fa-caret-down"></i></span></div>
<div class="collapsible-body">
<ul class="side-nav-panel">
