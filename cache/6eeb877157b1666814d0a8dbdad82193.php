<html>
<head>
	<title><?php echo $this->value['WebTitle']; ?>-<?php echo $this->value['ListName']; ?>-<?php echo $this->value['Name']; ?>电台介绍</title>
...
<div class="v-read">
	...
	<!-- 影片介绍 -->
	<div class="read-info">
		<div class="read-img"> <img src='<?php echo $this->value['StylePath']; ?>/img/radio.jpg'></div>
		<!-- 视频标题 -->
		...
		<div class="read-text uk-margin-top-remove uk-clearfix">
			<p class="uk-float-left">电台分类:<span><?php echo $this->value['ListName']; ?></span></p><p class="uk-float-left">更新时间:<span><?php echo $this->value['Time']; ?></span></p>
		</div>	
		<div class="read-btn uk-margin-top uk-margin-bottom uk-clearfix">
			<a href="<?php echo $this->value['CUrl']; ?>" class="uk-float-left">电台播放</a><a href="<?php echo $this->value['CUrl']; ?>" class="uk-float-right">备用电台</a>
		</div>
	</div>
</div>
...
<div class="v-type-favorite uk-clearfix">
	<!-- 相关视频 标题 -->
	<div class="v-type-title uk-clearfix uk-margin-top uk-margin-small-bottom"><h3 class="uk-float-left">推荐电台</h3></div>
	<!-- 视频缩略图 -->
	<ul class="recom recom-play">
			<?php  $RadioType=$this->value['RadioType']; $MYSQLVOD=(array)$this->value['RadioTypeNCSQL'];shuffle($MYSQLVOD);  $Count=8;for ($x=0; $x<=$Count-1; $x++) {  $MYSQLVODs=$MYSQLVOD[$x];  ?>
			<li>
				<a href="<?php 	echo  $Host1.'radio_detail'.$Host2.$MYSQLVODs['d_id'].$Host3.$RadioType.$Host4; ?>" class="uk-display-block ">
					...
					<div class="re-info">
						...
						<div class="re-detail">
							<span><i class="icon iconfont icon-play"></i><?php 	echo   rand(5, 10000); ?></span>
							<span><i class="icon iconfont icon-zan"></i>畅听电台乐趣无限</span>
						</div>
					</div>
				</a>
			</li>
