...
<div class="content">
<div class="bread-crumb"><a href="<?php echo $this->value['ListUrl']; ?>" title="<?php  echo $this->value['VideoTypeName']; ?>"><?php  echo $this->value['VideoTypeName']; ?></a></div>
...
<li><a href="<?php 	echo  $Host1.'video_detail'.$Host2.$s['d_id'].$Host3.$VideoTypeId.$Host4; ?>" title="<?php 	echo  $s['d_name'] ?>"><img src="<?php 	echo  $s['d_pic'] ?>" alt="<?php 	echo  $s['d_name'] ?>" class="responsive-image" style="height:200px;object-fit:cover;"></a></li>
<?php  } ?>
</ul>
