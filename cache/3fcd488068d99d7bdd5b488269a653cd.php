...
<div class="content">
<div class="bread-crumb"><a href="<?php echo $this->value['ListUrl']; ?>" title="<?php  echo $this->value['BookTypeName']; ?>"><?php  echo $this->value['BookTypeName']; ?></a></div>
...
<li><a href="<?php 	echo  $Host1.'book_detail'.$Host2.$s['a_id'].$Host3.$BookTypeId.$Host4; ?>" title="<?php 	echo  $s['a_name'] ?>"><img src="<?php 	echo  $s['a_pic'] ?>" alt="<?php 	echo  $s['a_name'] ?>" class="responsive-image" style="height:200px;object-fit:cover;"></a></li>
<?php  } ?>
</ul>
