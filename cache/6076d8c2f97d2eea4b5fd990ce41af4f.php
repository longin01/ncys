...
<div class="hero-header animated fadeindown"><a href="<?php echo $this->value['CUrl']; ?>" title="<?php echo $this->value['Name']; ?>"><img src="<?php echo $this->value['Pic']; ?>" alt="<?php echo $this->value['Name']; ?>"></a></div>
<div class="animated article fadeinup delay-1">
<div class="p-20">
<h2><?php echo $this->value['Name']; ?></h2>
<button class="waves-effect waves-light btn-large primary-color block animated bouncein delay-4" onClick="location.href='<?php echo $this->value['CUrl']; ?>';">在线浏览</button>
...
<?php  $PicType=$this->value['PicType']; $MYSQLVOD=(array)$this->value['PicTypeNCSQL'];shuffle($MYSQLVOD);  $Count=3;for ($x=0; $x<=$Count-1; $x++) {  $MYSQLVODs=$MYSQLVOD[$x];  ?>
<div class="swiper-slide"><a href="<?php 	echo  $Host1.'pic_detail'.$Host2.$MYSQLVODs['a_id'].$Host3.$PicType.$Host4; ?>" title="<?php 	echo  $MYSQLVODs['a_name'] ?>"><img src="<?php 	echo  $MYSQLVODs['a_remarks'] ?>" alt="<?php 	echo  $MYSQLVODs['a_name'] ?>"></a></div>
<?php  } ?>
</div>
...
<div class="card"><div class="header-hover"><div class="details"><span><?php 	echo  $MYSQLVODs['a_name'] ?></span><span class="small"><?php 	echo   rand(5, 10000); ?> 人浏览</span></div></div>
<div class="image"><a href="<?php 	echo  $Host1.'pic_detail'.$Host2.$MYSQLVODs['a_id'].$Host3.$PicType.$Host4; ?>" title="<?php 	echo  $MYSQLVODs['a_name'] ?>"><img src="<?php 	echo  $MYSQLVODs['a_remarks'] ?>" alt="<?php 	echo  $MYSQLVODs['a_name'] ?>"></a></div></div>
<?php  } ?>
</div>
</div>
<!-- 页尾 开始 -->
