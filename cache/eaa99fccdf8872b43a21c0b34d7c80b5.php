...
<div class="portfolio-item-full-width"><a href="<?php 	echo  $Host1.'pic_detail'.$Host2.$s['a_id'].$Host3.$PicTypeId.$Host4; ?>" title="<?php 	echo  $s['a_name'] ?>"><img src="<?php 	echo  $s['a_remarks'] ?>" alt="<?php 	echo  $s['a_name'] ?>" class="responsive-image" style="height:200px;object-fit:cover;"></a><h4><?php 	echo   rand(5, 10000); ?> 人浏览</h4><p><?php 	echo  $s['a_name'] ?></p></div><div class="decoration"></div>
<?php  } ?>
