...
<h1 class="hero-title primary-text"><a href="<?php echo $this->value['WEBUrl']; ?>"><?php  echo $this->value['PicTypeName']; ?></a></h1>
</div>
...
<div class="card"><div class="header-hover"><div class="details"><span><?php 	echo  $s['a_name'] ?></span><span class="small"><?php 	echo   rand(5, 10000); ?> 人浏览</span></div></div>
<div class="image"><a href="<?php 	echo  $Host1.'pic_detail'.$Host2.$s['a_id'].$Host3.$PicTypeId.$Host4; ?>" title="<?php 	echo  $s['a_name'] ?>"><img src="<?php 	echo  $s['a_remarks'] ?>" alt="<?php 	echo  $s['a_name'] ?>"></a></div></div>
<?php  } ?>
