				...
				<div class="right-container">
					...
					<div class="list-videos uk-margin-top uk-margin-bottom">
						...
						<div class="video-content uk-grid uk-grid-small">					
							<?php  $VideoType=1;  $Count=6;$MYSQLVODS = json_decode(file_get_contents('./TTSQL/Home/'.$VideoType.'.txt'),true); for ($x=0; $x<=$Count-1; $x++) {  $MYSQLVOD=$MYSQLVODS[$x];  ?>	
						...
						<div class="video-content uk-grid uk-grid-small">					
							<?php  $VideoType=4;  $Count=6;$MYSQLVODS = json_decode(file_get_contents('./TTSQL/Home/'.$VideoType.'.txt'),true); for ($x=0; $x<=$Count-1; $x++) {  $MYSQLVOD=$MYSQLVODS[$x];  ?>	
								<div class="uk-width-1-3 uk-margin-bottom">
								<a href="<?php 	echo  $Host1.'video_detail'.$Host2.$MYSQLVOD['d_id'].$Host3.$VideoType.$Host4; ?>" class="video-pic uk-display-block">
									<span class="live-tag"></span>
									<img src="<?php 	echo  $MYSQLVOD['d_pic'] ?>" alt="<?php 	echo  $MYSQLVOD['d_name'] ?>">
						...
						<div class="video-content uk-grid uk-grid-small">					
							<?php  $VideoType=6;  $Count=6;$MYSQLVODS = json_decode(file_get_contents('./TTSQL/Home/'.$VideoType.'.txt'),true); for ($x=0; $x<=$Count-1; $x++) {  $MYSQLVOD=$MYSQLVODS[$x];  ?>	
								<div class="uk-width-1-3 uk-margin-bottom">
								<a href="<?php 	echo  $Host1.'video_detail'.$Host2.$MYSQLVOD['d_id'].$Host3.$VideoType.$Host4; ?>" class="video-pic uk-display-block">
									<span class="live-tag"></span>
									<img src="<?php 	echo  $MYSQLVOD['d_pic'] ?>" alt="<?php 	echo  $MYSQLVOD['d_name'] ?>">
