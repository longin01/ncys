...
<head>
	...
	<title><?php echo $this->value['WebTitle']; ?>分类<?php  echo $this->value['BtTypeName']; ?>种子列表页</title>
			...
			<?php $mubantou=$this->value['Header'];$this->show($mubantou); ?>
				<div class="right-container">
                    ...
                    <div class="list-videos uk-margin-top uk-margin-bottom">
                        <div class="video-head uk-clearfix"><h3 class="h3-color uk-float-left">在线视频<?php  echo $this->value['BtTypeName']; ?>列表页</h3></div>
                        <div class="video-content uk-grid uk-grid-small">
                            <?php  $MYSQLVODS=(array)$this->value['BtTypeNCSQL'];$BtTypeId=$this->value['BtTypeId'];$GetMb_page=$this->value['BtTypePage']; $Count=9;$MYSQLVODS=PAGE($MYSQLVODS,$GetMb_page,$Count);  foreach($MYSQLVODS['source'] as $s){  ?>
                            <div class="uk-width-1-3 uk-margin-bottom">
                                <a href="<?php 	echo  $Host1.'bt_detail'.$Host2.$s['d_id'].$Host3.$BtTypeId.$Host4; ?>" class="video-pic uk-display-block">
                                    <span class="live-tag"></span>
                                    <img src="<?php 	echo  $s['d_pic'] ?>" alt="<?php 	echo  $s['d_name'] ?>">
                                </a>
                                <div class="video-title">
                                    <a href="#" class="uk-margin-small-bottom uk-margin-small-top uk-display-block"><?php 	echo  $s['d_name'] ?></a>
                ...
                <script type="text/javascript">
                    $("#wr-page").wrpage({
                        ...
                        baseUrl: '<?php 	echo $Host1.'bt_list'.$Host2.$BtTypeId.$Host3.'currentPage'.$Host4; ?>',
                    })
                </script>
