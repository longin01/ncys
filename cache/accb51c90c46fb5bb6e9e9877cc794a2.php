...
<body>
    <div class="w1200 uk-clearfix">
			<?php $mubantou=$this->value['Header'];$this->show($mubantou); ?>
                ...
                <div class="list-Bts uk-margin-top uk-margin-bottom">
                    <div class="Bt-head uk-clearfix uk-margin-bottom">
                        <!-- 面包屑 -->
                        ...
                        <div class="read">
                            ...
                            <div class="read-text uk-margin-top-remove uk-clearfix">
                                ...
                                <div class="read-btn uk-margin-bottom uk-float-left">
                                    <a href="<?php echo $this->value['CUrl']; ?>" class="uk-float-left uk-margin-large-right uk-button h-line ">种子下载</a>
                                    <a href="<?php echo $this->value['CUrl']; ?>" class="uk-float-left uk-margin-large-right uk-button h-line ">备用种子</a>
                                </div>
                                <p class="uk-float-left uk-margin-large-right">种子分类:<span><?php echo $this->value['ListName']; ?></span></p>
                    ...
                    <div class="video-head uk-clearfix">
                        <h3 class="h3-color uk-float-left"><?php echo $this->value['ListName']; ?>推荐种子</h3>
                        <a href="<?php echo $this->value['ListUrl']; ?>" class="more"><?php echo $this->value['ListName']; ?>更多推荐种子</a>
                    </div>
                    ...
                    <div class="video-content uk-grid uk-grid-small">
							...
							<?php  $BtType=$this->value['BtType']; $MYSQLVOD=(array)$this->value['BtTypeNCSQL'];shuffle($MYSQLVOD);  $Count=9;for ($x=0; $x<=$Count-1; $x++) {  $MYSQLVODs=$MYSQLVOD[$x];  ?>
							<div class="uk-width-1-3 uk-margin-bottom">
								<a href="<?php 	echo  $Host1.'bt_detail'.$Host2.$MYSQLVODs['d_id'].$Host3.$BtType.$Host4; ?>" class="video-pic video-pic-h uk-display-block">
