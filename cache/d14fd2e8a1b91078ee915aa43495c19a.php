...
<?php } ?>
<div class="mod-title">
<div id="link" class="block"><div id="title"><?php  echo $this->value['PicTypeName']; ?></div></div>
</div>
<div class="mod-row col5 clearfix">
<?php  $MYSQLVODS=(array)$this->value['PicTypeNCSQL'];$PicTypeId=$this->value['PicTypeId'];$GetMb_page=$this->value['PicTypePage']; $Count=30;$MYSQLVODS=PAGE($MYSQLVODS,$GetMb_page,$Count);  foreach($MYSQLVODS['source'] as $s){  ?>
<dl><dt><a href="<?php 	echo  $Host1.'pic_detail'.$Host2.$s['a_id'].$Host3.$PicTypeId.$Host4; ?>" title="<?php 	echo  $s['a_name'] ?>"><img src="<?php 	echo  $s['a_remarks'] ?>" alt="<?php 	echo  $s['a_name'] ?>"></a></dt></dl>
<?php  } ?>
</div>
