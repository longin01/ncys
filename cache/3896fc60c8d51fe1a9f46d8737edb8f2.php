...
<div class="entry"><a href="<?php 	echo  $Host1.'video_detail'.$Host2.$s['d_id'].$Host3.$s['d_type'].$Host4; ?>" title="<?php 	echo  $s['d_name'] ?>"><img src="<?php 	echo  $s['d_pic'] ?>" alt="<?php 	echo  $s['d_name'] ?>" class="imgPlay" style="height:200px;object-fit:cover;"></a>
<div class="content"><h5><a href="<?php 	echo  $Host1.'video_detail'.$Host2.$s['d_id'].$Host3.$s['d_type'].$Host4; ?>" title="<?php 	echo  $s['d_name'] ?>"><?php 	echo  $s['d_name'] ?></a></h5></div></div>
<?php  } ?>
