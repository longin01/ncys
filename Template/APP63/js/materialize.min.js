...
if ('undefined' == typeof jQuery) {
  ...
  jQuery.Velocity ? console.log('Velocity is already loaded. You may be needlessly importing Velocity again; note that Materialize includes Velocity.')  : (!function (a) {
    ...
    if (!a.jQuery) {
      ...
      c.extend = function () {
        ...
        d = f[e],
        h !== d && (k && d && (c.isPlainObject(d) || (b = c.isArray(d))) ? (b ? (b = !1, g = a && c.isArray(a) ? a : [
      ...
      c.uuid = 0;
      for (var e = {
      }, f = e.hasOwnProperty, g = e.toString, h = 'Boolean Number String Function Array Date RegExp Object Error'.split(' '), i = 0; i < h.length; i++) e['[object ' + h[i] + ']'] = h[i].toLowerCase();
    ...
    return function (a, b, c, d) {
      ...
      function f(a) {
        return p.isWrapped(a) ? a = [
        ].slice.call(a)  : p.isNode(a) && (a = [
          a
        ]),
        a
      }
      ...
      function k(a) {
        if (a) {
          ...
          c > 10000 && (t.State.calls = e(t.State.calls));
        ...
        Hooks: {
          ...
          register: function () {
            ...
            if (n) for (c in v.Hooks.templates) {
              ...
              'Color' === e[0] && (e.push(e.shift()), f.push(f.shift()), v.Hooks.templates[c] = [
                e.join(' '),
                f.join(' ')
              ])
            }
      ...
      Names: {
        ...
        prefixCheck: function (a) {
          if (t.State.prefixMatches[a]) return [t.State.prefixMatches[a],
          !0];
          for (var b = [
            '',
            'Webkit',
              ...
              if (RegExp('^' + v.Lists.colors.join('$|^') + '$').test(a)) {
                ...
                if (v.RegEx.isHex.test(e)) {
                  for (var h = [
                    ...
                    'Green',
                    'Blue'
                  ], i = v.Values.hexToRgb(e), j = g ? v.Values.hexToRgb(g)  : d, k = 0; k < h.length; k++) {
                    var m = [
                      i[k]
                    ];
                    f && m.push(f),
    ...
    i.element && (v.Values.addClass(f, 'velocity-animating'), J.push(i), '' === h.queue && (g(f).tweensContainer = i, g(f).opts = h), g(f).isAnimating = !0, y === x - 1 ? (t.State.calls.push([J,
    o,
    h,
    null,
    B.resolver]), t.State.isTicking === !1 && (t.State.isTicking = !0, k()))  : y++)
  }
  var e,
  f = this,
  h = m.extend({
      ...
      if (!m.isPlainObject(q) || p.isEmptyObject(q)) {
        if (p.isString(q) && t.Redirects[q]) {
          ...
          m.each(o, function (a, b) {
            ...
            E.drag && (E.duration = parseFloat(F) || (/^(callout|transition)/.test(q) ? 1000 : r), E.duration = Math.max(E.duration * (E.backwards ? 1 - a / x : (a + 1) / x), 0.75 * E.duration, 200)),
  ...
  this,
  b
  ]) ? (this.state & (ib | jb | kb) && (this.state = eb), this.state = this.process(b), void (this.state & (fb | gb | hb | jb) && this.tryEmit(b)))  : (this.reset(), void (this.state = kb))
  },
  process: function () {
  },
  ...
  'hammerjs'], a)  : 'object' == typeof exports ? a(require('jquery'), require('hammerjs'))  : a(jQuery, Hammer)
  }(function (a, b) {
  function c(c, d) {
  var e = a(c);
  ...
  lStack = ++b,
  j.attr('id', i).css('z-index', 1000 + 2 * lStack),
  h.data('overlay-id', i).css('z-index', 1000 + 2 * lStack + 1),
  h.addClass('open'),
  a('body').append(j),
  c = a.extend(g, c),
  ...
  })  : (a.Velocity.hook(h, 'scaleX', 0.7), h.css({
  top: c.starting_top
  }), h.velocity({
  top: c.ending_top,
  opacity: 1,
  ...
  a('body').append(f),
  'left' == b.edge ? (e.css('transform', 'translateX(-100%)'), f.css({
  left: 0
  ...
  if ('left' === b.edge && (f > b.menuWidth ? f = b.menuWidth : 0 > f && (f = 0)), 'left' === b.edge) f < b.menuWidth / 2 ? h = !1 : f >= b.menuWidth / 2 && (h = !0),
  ...
  0 > k && (k = 0),
  g = !1,
  'left' === b.edge ? h && 0.3 >= d || - 0.5 > d ? (0 !== j && e.velocity({
    translateX: [
      0,
      j
    ]
  ...
  return i || (f.on('scroll', m), f.on('resize', m), i = !0),
  setTimeout(m, 0),
  ...
  'input' !== b.type && (g = void 0 === b.pageX || null === b.pageX ? b.originalEvent.touches[0].pageX - a(this).offset().left : b.pageX - a(this).offset().left, 0 > g ? g = 0 : g > d && (g = d), c.addClass('active').css('left', g)),
  c.find('.value').html(a(this).val())
  }),
  ...
  function p() {
  var b;
  u.hiddenName === !0 ? (b = f.name, f.name = '')  : (b = [
  ...
  e = y.component.key[d],
  f = c.target;
  27 == d ? y.close(!0)  : f != y.$root[0] || !e && 13 != d ? a.contains(y.$root[0], f) && 13 == d && (c.preventDefault(), f.click())  : (c.preventDefault(), e ? b._.trigger(y.component.key.go, y, [
  b._.trigger(e)
  ])  : y.$root.find('.' + v.highlighted).hasClass(v.disabled) || y.set('select', y.component.item.highlight).close())
  })), y.trigger('open'))
  },
  close: function (a) {
  ...
  return d ? b._.trigger(y.component.formats.toString, y.component, [
    c,
    d
  ])  : ''
  }
  ...
  if ((!d || !d.nav) && (!m && j.disabled(c) || m && j.disabled(c) && (p || e || g) || !m && (c.pick <= n.pick || c.pick >= o.pick))) for (m && !p && (!g && l > 0 || !e && 0 > l) && (l *= - 1); j.disabled(c) && (Math.abs(l) > 1 && (c.month < k.month || c.month > k.month) && (c = k, l = l > 0 ? 1 : - 1), c.pick <= n.pick ? (h = !0, l = 1, c = j.create([n.year,
  n.month,
  ...
  for ((!b.no_wrap || q >= 0 && t > q) && (i = o[f(q)], i.style[A] = j + ' translateX(' + - e / 2 + 'px) translateX(' + g * b.shift * h * c + 'px) translateZ(' + b.dist * h + 'px)', i.style.zIndex = 0, b.full_width ? tweenedOpacity = 1 : tweenedOpacity = 1 - 0.2 * h, i.style.opacity = tweenedOpacity, i.style.display = 'block'), c = 1; d >= c; ++c) b.full_width ? (zTranslation = b.dist, tweenedOpacity = c === d && 0 > e ? 1 - h : 1)  : (zTranslation = b.dist * (2 * c + h * g), tweenedOpacity = 1 - 0.2 * (2 * c + h * g)),
  (!b.no_wrap || t > q + c) && (i = o[f(q + c)], i.style[A] = j + ' translateX(' + (b.shift + (s * c - e) / 2) + 'px) translateZ(' + zTranslation + 'px)', i.style.zIndex = - c, i.style.opacity = tweenedOpacity, i.style.display = 'block'),
  b.full_width ? (zTranslation = b.dist, tweenedOpacity = c === d && e > 0 ? 1 - h : 1)  : (zTranslation = b.dist * (2 * c - h * g), tweenedOpacity = 1 - 0.2 * (2 * c - h * g)),
  (!b.no_wrap || q - c >= 0) && (i = o[f(q - c)], i.style[A] = j + ' translateX(' + ( - b.shift + ( - s * c - e) / 2) + 'px) translateZ(' + zTranslation + 'px)', i.style.zIndex = - c, i.style.opacity = tweenedOpacity, i.style.display = 'block');
  (!b.no_wrap || q >= 0 && t > q) && (i = o[f(q)], i.style[A] = j + ' translateX(' + - e / 2 + 'px) translateX(' + g * b.shift * h + 'px) translateZ(' + b.dist * h + 'px)', i.style.zIndex = 0, b.full_width ? tweenedOpacity = 1 : tweenedOpacity = 1 - 0.2 * h, i.style.opacity = tweenedOpacity, i.style.display = 'block')
  }
  function h() {
  var a,
  b,
  ...
  e = q % t - d;
  0 !== e && (c.preventDefault(), c.stopPropagation()),
  k(d)
  }
  }
  function k(a) {
  ...
  0 > c ? H.trigger('carouselNext', [
  Math.abs(c)
  ])  : c > 0 && H.trigger('carouselPrev', [
  c
  ])
  }
  function l(a) {
  ...
  function n(a) {
  return r ? (r = !1, clearInterval(D), x = p, (z > 10 || - 10 > z) && (w = 0.9 * z, x = p + w), x = Math.round(x / s) * s, b.no_wrap && (x >= s * (t - 1) ? x = s * (t - 1)  : 0 > x && (x = 0)), w = x - p, C = Date.now(), requestAnimationFrame(i), E && (a.preventDefault(), a.stopPropagation()), !1)  : void 0
  }
  var o,
  p,
  q,
  ...
  if (H.hasClass('initialized')) return a(this).trigger('carouselNext', [
  0.000001
  ]),
  !0;
  if (b.full_width) {
  ...
  void 0 === b && (b = 1),
  x = p + s * b,
  p !== x && (w = x - p, C = Date.now(), requestAnimationFrame(i))
  }),
