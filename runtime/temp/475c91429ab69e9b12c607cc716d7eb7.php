<?php if (!defined('THINK_PATH')) exit(); /*a:16:{s:37:"template/mytheme/html/vod/search.html";i:1653471608;s:58:"/usr/local/html/cms/template/mytheme/html/public/data.html";i:1653471608;s:61:"/usr/local/html/cms/template/mytheme/html/seo/vod_search.html";i:1653471608;s:61:"/usr/local/html/cms/template/mytheme/html/public/include.html";i:1653471608;s:59:"/usr/local/html/cms/template/mytheme/html/public/style.html";i:1653471608;s:56:"/usr/local/html/cms/template/mytheme/html/diy/style.html";i:1653471608;s:58:"/usr/local/html/cms/template/mytheme/html/public/head.html";i:1653471608;s:59:"/usr/local/html/cms/template/mytheme/html/block/vod_no.html";i:1653471608;s:60:"/usr/local/html/cms/template/mytheme/html/block/vod_box.html";i:1653471608;s:58:"/usr/local/html/cms/template/mytheme/html/public/page.html";i:1653471608;s:60:"/usr/local/html/cms/template/mytheme/html/block/vod_hot.html";i:1653471608;s:66:"/usr/local/html/cms/template/mytheme/html/block/vod_box_media.html";i:1653471608;s:65:"/usr/local/html/cms/template/mytheme/html/block/vod_box_rank.html";i:1653471608;s:60:"/usr/local/html/cms/template/mytheme/html/block/art_hot.html";i:1653471608;s:58:"/usr/local/html/cms/template/mytheme/html/public/foot.html";i:1653471608;s:62:"/usr/local/html/cms/template/mytheme/html/user/ajax_login.html";i:1653471608;}*/ ?>
<?php 
...
<title><?php echo $param['wd']; ?><?php echo $param['actor']; ?><?php echo $param['director']; ?><?php echo $param['area']; ?><?php echo $param['lang']; ?><?php echo $param['year']; ?><?php echo $param['class']; ?>搜索结果 - <?php echo $mytheme['site']['title']; ?></title>
...
<?php if($mytheme['skin']['is'] && !$mytheme['color']['is']): $_628e1b46bda60=explode(',',''.$mytheme['skin']['style'].''); if(is_array($_628e1b46bda60) || $_628e1b46bda60 instanceof \think\Collection || $_628e1b46bda60 instanceof \think\Paginator): if( count($_628e1b46bda60)==0 ) : echo "" ;else: foreach($_628e1b46bda60 as $key=>$vo): ?>
		...
		<div class="row">
			<div class="myui-header_bd clearfix">					
					...
					<li class="dropdown-hover<?php if(!$mytheme['nav']['more']): ?> visible-sm visible-xs<?php endif; ?>">
						...
						<div class="dropdown-box bottom fadeInDown clearfix">
							<ul class="item nav-list clearfix">
			                    ...
			                    <?php endforeach; endif; else: echo "" ;endif; if($mytheme['subnav']['is']): $__FOR_START_1049936013__=1;$__FOR_END_1049936013__=5;for($i=$__FOR_START_1049936013__;$i <= $__FOR_END_1049936013__;$i+=1){ if($mytheme['subnav']['url'.$i.'']): ?><li class="col-lg-5 col-md-5 col-sm-5 col-xs-3"><a  class="btn btn-sm btn-block btn-default" href="<?php echo $mytheme['subnav']['url'.$i.'']; ?>"><?php echo $mytheme['subnav']['text'.$i.'']; ?></a></li><?php endif; } endif; ?>
							</ul>
						</div>
					</li>
					<?php endif; ?>
				...
				<div class="myui-header__search search-box"> 
					...
					<div class="search-dropdown-hot dropdown-box bottom fadeInDown">
						<div class="item">
							...
							<?php $_628e1b46bd88f=explode(',',''.$mytheme['search'][hot].''); if(is_array($_628e1b46bd88f) || $_628e1b46bd88f instanceof \think\Collection || $_628e1b46bd88f instanceof \think\Paginator): if( count($_628e1b46bd88f)==0 ) : echo "" ;else: foreach($_628e1b46bd88f as $key=>$vo): ?>
				...
				<ul class="myui-header__user">	
					...
					<?php endif; if($mytheme['nav1']['is']): $__FOR_START_1908405626__=1;$__FOR_END_1908405626__=3;for($i=$__FOR_START_1908405626__;$i <= $__FOR_END_1908405626__;$i+=1){ if($mytheme['nav1']['url'.$i.'']): ?><li><a href="<?php echo $mytheme['nav1']['url'.$i.'']; ?>" title="<?php echo $mytheme['nav1']['text'.$i.'']; ?>"><i class="fa <?php echo $mytheme['nav1']['icon'.$i.'']; ?>"></i></a></li><?php endif; } endif; if($maccms['user_status'] == 1): if($user['group']['group_id'] == 1): ?>
					<li>
	    				...
	    				<div class="myui-panel-box clearfix">
	    					<div class="myui-panel_hd">
	    						<div class="myui-panel__head active bottom-line clearfix">	
	    							<h3 class="title">
	    								与 <span class="text-red">“<?php echo $param['wd']; ?><?php echo $param['actor']; ?><?php echo $param['director']; ?><?php echo $param['area']; ?><?php echo $param['lang']; ?><?php echo $param['year']; ?><?php echo $param['class']; ?><?php echo $param['tag']; ?>”</span> 相关的搜索结果
	    							</h3>
	    						</div>
	    					</div>
	    					...
	    					<div class="myui-panel_bd col-pd clearfix">
	    						<ul class="myui-vodlist__media clearfix" id="searchList">		
	    							<?php $__TAG__ = '{"num":"'.$mytheme['searchpage']['num'].'","paging":"yes","pageurl":"vod\/search","order":"desc","by":"time","id":"vo","key":"key"}';$__LIST__ = model("Vod")->listCacheData($__TAG__);$__PAGING__ = mac_page_param($__LIST__['total'],$__LIST__['limit'],$__LIST__['page'],$__LIST__['pageurl'],$__LIST__['half']); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?>		
	    							<li class="clearfix">
	    								<div class="thumb">									
	    									<a class="myui-vodlist__thumb img-lg-150 img-md-150 img-sm-150 img-xs-100 lazyload" href="<?php echo mac_url_vod_detail($vo); ?>" title="<?php echo $vo['vod_name']; ?>" data-original="<?php echo mac_url_img($vo['vod_pic']); ?>">
	    								...
	    								<div class="detail">
	    							    	<h4 class="title"><a class="searchkey" href="<?php echo mac_url_vod_detail($vo); ?>"><?php echo $vo['vod_name']; ?></a></h4>
	    									...
	    									<p><span class="text-muted">分类：</span><?php echo $vo['type']['type_name']; ?><span class="split-line"></span><span class="text-muted hidden-xs">地区：</span><?php echo mac_default($vo['vod_area'],'内详'); ?><span class="split-line"></span><span class="text-muted hidden-xs">年份：</span><?php echo mac_default($vo['vod_year'],'内详'); ?></p>		
	    									<p class="hidden-xs"><span class="text-muted">简介：</span><?php echo mac_substring(mac_filter_html($vo['vod_content']),50); ?>...<a href="<?php echo mac_url_vod_detail($vo); ?>">详情 &gt;</a></p>
	    									<p class="margin-0">
	    										<a class="btn btn-sm btn-warm" href="<?php echo mac_url_vod_play($vo,['sid'=>1,'nid'=>1]); ?>"><i class="fa fa-play"></i> 立即播放</a>&nbsp;&nbsp;
	    										<a class="btn btn-sm btn-default hidden-xs" href="<?php echo mac_url_vod_detail($vo); ?>">查看详情 <i class="fa fa-angle-right"></i></a>
	    									</p>												    	    																									
	    								</div>
	    							</li>
	    							<?php endforeach; endif; else: echo "" ;endif; ?>
...
<!-- 无结果 -->
	    			...
	    			<?php if($mytheme['search_ad'] && $mytheme['search_ad1']): ?>
	    			<div class="myui-panel myui-panel-bg clearfix">
	    				<div class="myui-panel-box clearfix">
	    					<div class="myui-panel_bd">
	    						<div class="col-xs-1">
	    							<?php echo $mytheme['search_ad1']; ?>
	    						</div>
	    					</div>
	    				</div>
	    			</div>
...
<?php endif; ?><!-- 翻页 -->
	    		...
	    		<div class="col-md-wide-3 col-xs-1 <?php echo $mytheme['searchpage']['side_self']; ?> myui-sidebar">
	    			<?php if($mytheme['side']['vod']): ?>
<div class="myui-panel myui-panel-bg clearfix">
	<div class="myui-panel-box clearfix">
		<div class="myui-panel_hd">
			<div class="myui-panel__head clearfix">
				<h3 class="title">
					<?php echo $mytheme['side']['vod_title']; ?>
				</h3>	
				<a class="more text-muted" href="<?php echo $maccms['path']; ?>">更多  <i class="fa fa-angle-right"></i></a>
			</div>																		
		</div>
		<div class="myui-panel_bd">
			<ul class="myui-vodlist__media active col-pd clearfix">
				<?php $__TAG__ = '{"num":"1","type":"'.$mytheme[side][vod_id].'","order":"desc","by":"'.$mytheme[side][vod_by].'","id":"vo","key":"key"}';$__LIST__ = model("Vod")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?>
					<li>
	<div class="thumb">
...
<?php endif; ?>
	...
	<?php if($mytheme['search']['key']): ?>
	<script type="text/javascript">
		var wdkey= /<?php echo $param['wd']; ?>/g;
		$('.searchkey').each(function(){
			var wd=$(this).html();
			wd = wd.replace(wdkey, '<font color=red><?php echo $param['wd']; ?></font>');
			$(this).html(wd);
		});
	</script>
	<?php endif; ?>
...
<div class="myui-nav__tabbar">
	<?php $__FOR_START_457980856__=1;$__FOR_END_457980856__=6;for($i=$__FOR_START_457980856__;$i <= $__FOR_END_457980856__;$i+=1){ if($mytheme['tabbar']['url'.$i.'']): ?>
...
<ul class="myui-extra clearfix">
	...
	<?php endif; if($mytheme['nav2']['sub']): $__FOR_START_1653907111__=1;$__FOR_END_1653907111__=3;for($i=$__FOR_START_1653907111__;$i <= $__FOR_END_1653907111__;$i+=1){ if($mytheme['nav2']['url'.$i.'']): ?><li><a href="<?php echo $mytheme['nav2']['url'.$i.'']; ?>" title="<?php echo $mytheme['nav2']['text'.$i.'']; ?>"><i class="fa <?php echo $mytheme['nav2']['icon'.$i.'']; ?>"></i></a></li><?php endif; } endif; ?>
</ul>
...
<script type="text/javascript">
	<?php $_628e1b46bd3df=explode(',',''.$mytheme['click']['url'].''); if(is_array($_628e1b46bd3df) || $_628e1b46bd3df instanceof \think\Collection || $_628e1b46bd3df instanceof \think\Paginator): if( count($_628e1b46bd3df)==0 ) : echo "" ;else: foreach($_628e1b46bd3df as $key=>$vo): ?>
