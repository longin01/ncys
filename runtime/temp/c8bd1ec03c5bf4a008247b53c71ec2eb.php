<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:56:"/usr/local/html/cms/application/admin/view/vod/info.html";i:1653471608;s:59:"/usr/local/html/cms/application/admin/view/public/head.html";i:1653471608;s:61:"/usr/local/html/cms/application/admin/view/public/editor.html";i:1653471608;s:59:"/usr/local/html/cms/application/admin/view/public/foot.html";i:1653471608;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<script type="text/javascript">
    ...
    layui.use(['form','upload', 'layer'], function () {
        ...
        upload.render({
            ...
            , method: 'post'
            , exts: 'mp4|mp3|mkv|flv|wmv|mpg|torrent|zip|txt|rar'
            , before: function (input) {
                layer.msg('文件上传中...', {time: 3000000});
            }, done: function (res, index, upload) {
                var obj = this.item;
