<?php if (!defined('THINK_PATH')) exit(); /*a:25:{s:38:"template/mytheme/html/index/index.html";i:1652600927;s:58:"/usr/local/html/cms/template/mytheme/html/public/data.html";i:1652600927;s:56:"/usr/local/html/cms/template/mytheme/html/seo/index.html";i:1652600927;s:61:"/usr/local/html/cms/template/mytheme/html/public/include.html";i:1652600927;s:59:"/usr/local/html/cms/template/mytheme/html/public/style.html";i:1652600927;s:56:"/usr/local/html/cms/template/mytheme/html/diy/style.html";i:1652600927;s:58:"/usr/local/html/cms/template/mytheme/html/public/head.html";i:1652600927;s:58:"/usr/local/html/cms/template/mytheme/html/index/slide.html";i:1652600927;s:56:"/usr/local/html/cms/template/mytheme/html/index/hot.html";i:1652600927;s:60:"/usr/local/html/cms/template/mytheme/html/block/vod_box.html";i:1652600927;s:57:"/usr/local/html/cms/template/mytheme/html/index/list.html";i:1652600927;s:65:"/usr/local/html/cms/template/mytheme/html/block/vod_box_rank.html";i:1652600927;s:58:"/usr/local/html/cms/template/mytheme/html/index/video.html";i:1652600927;s:67:"/usr/local/html/cms/template/mytheme/html/block/vod_box_active.html";i:1652600927;s:58:"/usr/local/html/cms/template/mytheme/html/index/topic.html";i:1652600927;s:57:"/usr/local/html/cms/template/mytheme/html/index/rank.html";i:1652600927;s:66:"/usr/local/html/cms/template/mytheme/html/block/vod_box_media.html";i:1652600927;s:58:"/usr/local/html/cms/template/mytheme/html/index/actor.html";i:1652600927;s:62:"/usr/local/html/cms/template/mytheme/html/block/actor_box.html";i:1652600927;s:56:"/usr/local/html/cms/template/mytheme/html/index/art.html";i:1652600927;s:61:"/usr/local/html/cms/template/mytheme/html/block/art_box2.html";i:1652600927;s:57:"/usr/local/html/cms/template/mytheme/html/index/logo.html";i:1652600927;s:57:"/usr/local/html/cms/template/mytheme/html/index/link.html";i:1652600927;s:58:"/usr/local/html/cms/template/mytheme/html/public/foot.html";i:1652600927;s:62:"/usr/local/html/cms/template/mytheme/html/user/ajax_login.html";i:1652600927;}*/ ?>
<?php 
...
<?php if($mytheme['skin']['is'] && !$mytheme['color']['is']): $_6280b10574a46=explode(',',''.$mytheme['skin']['style'].''); if(is_array($_6280b10574a46) || $_6280b10574a46 instanceof \think\Collection || $_6280b10574a46 instanceof \think\Paginator): if( count($_6280b10574a46)==0 ) : echo "" ;else: foreach($_6280b10574a46 as $key=>$vo): ?>
		...
		<div class="row">
			<div class="myui-header_bd clearfix">					
				...
				<ul class="myui-header__menu nav-menu">
                    ...
                    <?php endforeach; endif; else: echo "" ;endif; if($mytheme['subnav']['is']): $__FOR_START_514552708__=1;$__FOR_END_514552708__=5;for($i=$__FOR_START_514552708__;$i <= $__FOR_END_514552708__;$i+=1){ if($mytheme['subnav']['url'.$i.'']): ?><li class="<?php if($GLOBALS['type_id'] == $mytheme['subnav']['id'.$i.''] || $maccms['aid'] == $mytheme['subnav']['id'.$i.'']): ?>active<?php endif; ?> hidden-md hidden-sm hidden-xs"><a href="<?php echo $mytheme['subnav']['url'.$i.'']; ?>"><?php echo $mytheme['subnav']['text'.$i.'']; ?></a></li><?php endif; } endif; if($maccms['aid'] == 15): ?>
					<li class="visible-xs">
					...
					<li class="dropdown-hover<?php if(!$mytheme['nav']['more']): ?> visible-sm visible-xs<?php endif; ?>">
						...
						<div class="dropdown-box bottom fadeInDown clearfix">
							<ul class="item nav-list clearfix">
			                    ...
			                    <?php endforeach; endif; else: echo "" ;endif; if($mytheme['subnav']['is']): $__FOR_START_1175813221__=1;$__FOR_END_1175813221__=5;for($i=$__FOR_START_1175813221__;$i <= $__FOR_END_1175813221__;$i+=1){ if($mytheme['subnav']['url'.$i.'']): ?><li class="col-lg-5 col-md-5 col-sm-5 col-xs-3"><a  class="btn btn-sm btn-block btn-default" href="<?php echo $mytheme['subnav']['url'.$i.'']; ?>"><?php echo $mytheme['subnav']['text'.$i.'']; ?></a></li><?php endif; } endif; ?>
							</ul>
						</div>
					</li>
					<?php endif; ?>
				...
				<div class="myui-header__search search-box"> 
					...
					<div class="search-dropdown-hot dropdown-box bottom fadeInDown">
						<div class="item">
							...
							<?php $_6280b10574677=explode(',',''.$mytheme['search'][hot].''); if(is_array($_6280b10574677) || $_6280b10574677 instanceof \think\Collection || $_6280b10574677 instanceof \think\Paginator): if( count($_6280b10574677)==0 ) : echo "" ;else: foreach($_6280b10574677 as $key=>$vo): ?>
				...
				<ul class="myui-header__user">	
					...
					<?php endif; if($mytheme['nav1']['is']): $__FOR_START_32126523__=1;$__FOR_END_32126523__=3;for($i=$__FOR_START_32126523__;$i <= $__FOR_END_32126523__;$i+=1){ if($mytheme['nav1']['url'.$i.'']): ?><li><a href="<?php echo $mytheme['nav1']['url'.$i.'']; ?>" title="<?php echo $mytheme['nav1']['text'.$i.'']; ?>"><i class="fa <?php echo $mytheme['nav1']['icon'.$i.'']; ?>"></i></a></li><?php endif; } endif; if($maccms['user_status'] == 1): if($user['group']['group_id'] == 1): ?>
					<li>
...
<!-- 推荐 -->	              	
	        	...
	        	<?php if($mytheme['home_list']['is']): $_6280b10574096=explode(',',''.$mytheme['home_list']['id'].''); if(is_array($_6280b10574096) || $_6280b10574096 instanceof \think\Collection || $_6280b10574096 instanceof \think\Paginator): if( count($_6280b10574096)==0 ) : echo "" ;else: foreach($_6280b10574096 as $key=>$vo): $__TAG__ = '{"order":"asc","by":"sort","ids":"'.$vo.'","id":"vo1","key":"key1","flag":"vod"}';$__LIST__ = model("Type")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key1 = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($key1 % 2 );++$key1;?>
<div class="myui-panel myui-panel-bg clearfix">
	<div class="myui-panel-box clearfix">		
		<div class="myui-panel_bd clearfix">
	...
	<div class="myui-panel-box clearfix">
		...
		<div class="myui-panel_bd clearfix">
			<ul class="myui-link__pic clearfix">
				<?php $_6280b10573cf8=explode(',',''.$mytheme['home_partner']['name'].''); if(is_array($_6280b10573cf8) || $_6280b10573cf8 instanceof \think\Collection || $_6280b10573cf8 instanceof \think\Paginator): if( count($_6280b10573cf8)==0 ) : echo "" ;else: foreach($_6280b10573cf8 as $key=>$vo): ?>
...
<div class="myui-nav__tabbar">
	<?php $__FOR_START_1482310205__=1;$__FOR_END_1482310205__=6;for($i=$__FOR_START_1482310205__;$i <= $__FOR_END_1482310205__;$i+=1){ if($mytheme['tabbar']['url'.$i.'']): ?>
...
<ul class="myui-extra clearfix">
	...
	<?php endif; if($mytheme['nav2']['sub']): $__FOR_START_1882701897__=1;$__FOR_END_1882701897__=3;for($i=$__FOR_START_1882701897__;$i <= $__FOR_END_1882701897__;$i+=1){ if($mytheme['nav2']['url'.$i.'']): ?><li><a href="<?php echo $mytheme['nav2']['url'.$i.'']; ?>" title="<?php echo $mytheme['nav2']['text'.$i.'']; ?>"><i class="fa <?php echo $mytheme['nav2']['icon'.$i.'']; ?>"></i></a></li><?php endif; } endif; ?>
</ul>
...
<script type="text/javascript">
	<?php $_6280b105739a1=explode(',',''.$mytheme['click']['url'].''); if(is_array($_6280b105739a1) || $_6280b105739a1 instanceof \think\Collection || $_6280b105739a1 instanceof \think\Paginator): if( count($_6280b105739a1)==0 ) : echo "" ;else: foreach($_6280b105739a1 as $key=>$vo): ?>
