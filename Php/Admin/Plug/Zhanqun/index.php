...
$AdminTop = json_decode(file_get_contents("../TTSQL/Admin/Plug/Zhanqun/index.php"),true);
include('../Php/Public/Mysql.php');	
$file = fopen("../TTSQL/Admin/Plug/Zhanqun/index.php","w");
                        ...
                        <div class="am-u-sm-12 am-u-md-6">
                            <div class="am-btn-toolbar">
                                <div class="am-btn-group am-btn-group-xs">
									 <a href="?Php=Plug/Zhanqun/add"><button type="button" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span> 添加域名</button></a>
                                </div>
                            </div>
                        </div>
...
$Zhanqun = json_decode(file_get_contents("../TTSQL/Admin/Plug/Zhanqun/index.php"),true);
...
<tr>
	...
	<td>
		<div class="am-btn-toolbar">
			<div class="am-btn-group am-btn-group-xs">
				<a href="?Php=Plug/Zhanqun/mod&Id=<?php echo $x?>" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 详细设置</a>					
				<a href="?Php=Plug/Zhanqun/index&Id=<?php echo $x?>" onclick="return confirm('确定要删除吗？')" target="_blank" class="am-btn am-btn-default am-btn-xs am-text-danger _am-hide-sm-only"><span class="am-icon-trash-o"></span> 删除</a>
			</div>
		</div>
	</td>
</tr>
